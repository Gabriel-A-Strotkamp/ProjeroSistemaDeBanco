 ...
 */
public class VerClientesJF extends javax.swing.JFrame {
    PersistenciaJPA jpa;
    Clientes cliente;
    /**
     * Creates new form VerClientesJF
     */
    public VerClientesJF() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Lista de Clintes!");
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        TelaCadCliente telaCadastro= new TelaCadCliente();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
           Clientes clienteSel = lstClientes.getSelectedValue();
        if (clienteSel != null) {
            TelaCadCliente telaEdt = new TelaCadCliente();
            telaEdt.setCliente(clienteSel);
    ...
    if (clienteSel == null) {
        ...
        int opDel = JOptionPane.showConfirmDialog(rootPane,
                "Tem Certeza que deseja remover o cliente: " + clienteSel.getNome() + "?", // Assumindo que Cliente tem um getNome()
                "Confirmar Exclusão",
                JOptionPane.YES_NO_OPTION);

         if (opDel == JOptionPane.YES_OPTION) {
            try {
                Clientes clienteGerenciado = (Clientes) jpa.find(Clientes.class, clienteSel.getId());
                ...
                if (clienteGerenciado != null) {
                    ...
                    JOptionPane.showMessageDialog(null, "Cliente não encontrado ou já removido.", "Erro", JOptionPane.ERROR_MESSAGE);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerClientesJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerClientesJF().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<Clientes> lstClientes;
